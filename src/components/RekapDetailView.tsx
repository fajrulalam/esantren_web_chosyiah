    ...
    try {
      ...
      if (invoiceDoc.exists()) {
        ...
        const defaultTemplates = {
          reminderMessage: `[PESAN OTOMATIS DARI Esantren Hurun Inn]\n\nAssalamu'alaikum Wr. Wb. Wali Santri Santri Ananda {nama},\n\nmengingatkan kembali mengenai pembayaran *{paymentName}* sebesar *{amount}* yang masih belum terselesaikan. \n\nBapak/Ibu dapat mengununggah bukti pembayaran ke website Esantren Hurun Inn: https://hurun-in.vercel.app/\n\nJazakumullah khairan katsiran.`,
