...
export default function Navbar() {
  ...
  const navbarClasses = `
        ...
        ${
          isScrolled
            ? "bg-amber-50/95 dark:bg-gray-900/95 backdrop-blur-md py-3 shadow-md dark:shadow-gray-800/30"
          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center gap-2">
                <Image
                  src={theme === "dark" ? "/hurun inn logo dark mode.png" : "/hurun_inn_favicon.png"}
                  alt="Logo Hurun Inn"
                  width={48}
                  height={48}
                  ...
                  {user.role !== "waliSantri" ? (
                    <>
                      ...
                      {/* <Link
                        href="/izin-admin"
                        className={
                          isActive("/izin-admin") ? activeClass : inactiveClass
                        }
                      >
                        Izin Santri
                      </Link> */}
                    ...
                    <>
                      ...
                      <Link
                        href="/izin-santri"
                        className={
                          isActive("/izin-santri") ? activeClass : inactiveClass
                        }
                      >
                        Izin Sakit/Pulang
                      </Link>
