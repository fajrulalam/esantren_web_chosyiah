...
import { downloadSantriTemplate } from "@/utils/excelTemplate";
...
export default function CSVImportModal({
  ...
  return (
    <ModalPortal isOpen={isOpen} onClose={onClose} maxWidth="3xl">
      <h3 className="text-lg font-medium leading-6 text-gray-900 dark:text-white mb-4 transition-colors">
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center space-y-2">
            <svg
              ...
              className="h-10 w-10 text-gray-400 dark:text-gray-500 transition-colors"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 transition-colors">
                <thead className="bg-gray-50 dark:bg-gray-800 transition-colors">
                  <tr>
                    <th
                      scope="col"
                      className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider transition-colors"
                    >
                      Nama
                    </th>
                    <th
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4 transition-colors">
          ...
          <ul className="text-xs text-blue-700 dark:text-blue-400 list-disc pl-5 space-y-1 transition-colors">
            ...
            <li>
              Data wajib memiliki kolom:{" "}
              <strong>nama, kodeAsrama, statusAktif, nomorTelpon</strong>
            </li>
            <li>
              Kolom opsional:{" "}
              <strong>
                nomorWalisantri, tanggalLahir, kamar, "semester/kelas",
                tahunMasuk, jenjangPendidikan, programStudi
              </strong>
            </li>
            <li>Kolom tambahan lainnya akan diimpor secara otomatis</li>
            <li>
              <button
                className="text-blue-600 dark:text-blue-400 underline transition-colors hover:text-blue-800 dark:hover:text-blue-300 focus:outline-none"
                onClick={(e) => {
                  e.preventDefault();
                  downloadSantriTemplate();
                }}
              >
