                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
                    ...
                    <div className="md:w-1/2 w-full flex flex-col gap-4">
                        ...
                        <a
                            ...
                            className="block cursor-pointer transition-transform hover:scale-[1.01] duration-300"
                        ...
                        >
                            <div className="relative w-full rounded-2xl overflow-hidden shadow-md border border-amber-100 dark:border-gray-700" style={{ aspectRatio: '1618/1080' }}>
                                <Image
                                    ...
                                    className="hover:opacity-98 transition-opacity"
                                />
                                <div className="absolute bottom-3 right-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full px-2.5 py-1 text-xs text-amber-855 dark:text-amber-300 shadow-sm flex items-center font-semibold">
                        ...
                        <div className="order-1 md:order-2 space-y-6">
                            ...
                            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-5 rounded-xl shadow-md border border-amber-100 dark:border-gray-700">
                                <h3 className="text-lg font-semibold text-amber-800 dark:text-amber-400 mb-3 flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="mr-2 text-amber-600 dark:text-amber-500">
                                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.955c-.003 5.444-4.437 9.88-9.875 9.88z"/>
                                    </svg>
                                ...
                                <div className="space-y-2 text-sm">
                                    <div className="flex flex-col gap-2">
                                        <a
                                            href="https://wa.me/6285784541496"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center gap-2 text-amber-900 dark:text-amber-300 font-medium hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors duration-200 group w-fit"
                                        >
                                            <div className="p-1.5 bg-emerald-100 dark:bg-emerald-950/40 rounded-full flex-shrink-0 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-900/60 group-hover:scale-105 transition-all duration-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-emerald-600 dark:text-emerald-400">
                                                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.955c-.003 5.444-4.437 9.88-9.875 9.88z"/>
                                                </svg>
                                            </div>
                                            <span>+62 857-8454-1496 (Ustadzah Alivia)</span>
                                        </a>
                                        <a
                                            href="https://wa.me/6289678962686"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center gap-2 text-amber-900 dark:text-amber-300 font-medium hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors duration-200 group w-fit"
                                        >
                                            ...
                                            <span>+62 896-7896-2686 (Ustadzah Shafira)</span>
                                        </a>
                                    </div>
                                    {/* Email Contact */}
